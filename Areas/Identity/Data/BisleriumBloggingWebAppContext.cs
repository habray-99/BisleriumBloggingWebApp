...
namespace BisleriumBloggingWebApp.Data;

public class BisleriumBloggingWebAppContext : IdentityDbContext<CustomUser>
{
    public BisleriumBloggingWebAppContext(DbContextOptions<BisleriumBloggingWebAppContext> options)
        : base(options)
    {
    }
